        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Definition = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingOk = table.Column<bool>(type: "bit", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_ShoppingLists_ShoppingLists_ShoppingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_ShoppingLists_ShoppingId",
                table: "Product_ShoppingLists",
                column: "ShoppingId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Roles_Definition",
                table: "Roles",
                column: "Definition",
                unique: true,
                filter: "[Definition] IS NOT NULL");
